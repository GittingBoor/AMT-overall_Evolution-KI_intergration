...
\end{enumerate}
Je nach Modul, welches gerade genutzt wird, werden nur paar oder alle dieser Methoden eingesetzt.
...
und unter welchen Voraussetzungen sich für welches System entschieden werden sollte.
