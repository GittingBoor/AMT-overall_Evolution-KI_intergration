...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[>=stealth, thick]
        ...
        % Obere Zeile
        \node at (0,1) (input) {Audio Input};
        \node at (5,1) (prep) {Vorverarbeitung};
        \node at (9,1) (onset) {Onset-Detektion};
        \node at (12.75,1) (rasta) {RASTA-Filtering};
