...
wodurch die betroffenen Layer im Netzwerk fast gar nichts lernen.
...
Desto tiefer das Netzwerk ist, desto mehr Layer müssen die Gradienten durchlaufen.
Mit jedem Layer wird der Gradient somit exponentiell kleiner.
...
Dadurch entsteht die doppelte Menge Hidden States und die gesamte Vorhersage wird sehr viel robuster.
\[
