...
Basierend auf dieser gibt es einige besser Systeme,
welcher Aktiv in AMT-Systemen und anderen KI-Systemen genutzt werden.
Eines dieser Systeme sind Long Short-Term Memory (LSTM).
Auf dieses werde ich im folgenden Kapitel weiter eingehen.
