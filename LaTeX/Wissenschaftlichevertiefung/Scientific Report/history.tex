...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Graphics/Martin1996Structure}
...
spaltet sich Martins AMT-System auf, in einem Analysepfad und einen Rhythmuspfad.
...
Durch simultaner und sequentieller AAnalyse der Intervalle kann man
jedoch den gegebenen Noten den passenden Stimmen rekursiv zuordnen.
...
Lag soll in diesem Fall darstellen, wann sich ein bestimmtes Singal wiederholt.
Heißt wenn ich einen Ton mit der Frequenz x spiele
und dieser sich nach zum Beispiel 10ms wiederholt wird das Visuel im Lag dargestellt.
Aufbauend auf das Correlogram werden einige Analysen angewendet.
% Summary Autocorrelation
% Peaks
% Periodicities

% Rhythmuspfad (Und alle anderen ChatGPT LaTeX chatverlaufen schauen)
