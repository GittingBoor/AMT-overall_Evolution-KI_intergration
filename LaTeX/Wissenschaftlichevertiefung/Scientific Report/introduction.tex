...
Das neuronale Netz einer KI ist mehrdimensional aufgebaut, wodurch dieses verschiedene Patterns,
Stimmen oder andere Eigenschaften besser zuordnen und erlernen kann.     % Hier Quelle einfügen die Mehrdimensionalität von KI im Kontext AMT eingeht
...
Hier werden meistens Recurrent Neural Networks (RNN) oder Convolutional Neural Networks (CNN) benutzt. % Hier Quellen die CNN oder RNN benutzen
Da Musik keine definierbaren richtigen oder falschen Musikstücke, Notenabfolgen oder anderes hat,
kann man keine Reinforcement Learning KI-Modelle nutzen.
...
So können Töne einfacher bestimmten Akkorden zugeordnet werden oder der Rhythmus des Musikstückes erkannt werden.  % Quelle die das besagt
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item Oder als Transkription in standardisierter Notenschrift
    \end{itemize}
\end{enumerate}
